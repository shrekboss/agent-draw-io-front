...
- Backend connectivity errors:
    - The API service detects backend unavailability and surfaces actionable messages. Verify NEXT_PUBLIC_API_BASE_URL
...
- Component tests for UI:
    - Render the main page with mocked API and simulate user interactions (agent selection, sending messages,
      exporting).
